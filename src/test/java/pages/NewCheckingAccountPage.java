...
public class NewCheckingAccountPage extends HomePage {
    ...
    public NewCheckingAccountPage() throws MalformedURLException {
    ...
    public void createNewCheckingAccount(AccountType accountType, AccountOwnership ownership, String accountName, String initialBalance) {
    ...
    public void createNewCheckingAccountAndReset(AccountType accountType, AccountOwnership ownership, String accountName, String initialBalance) {
